...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Menu Data {{ $store->name }}
...
<script>
    $('.table').DataTable({
        serverSide: true,
        ajax: {
            url: '/api/admin/store/data/menu/dataTable/<?= $store->id ?>',
        },
        columns: [{
                data: 'id'
            },
            ...
            },
            {
                ...
                render: (image) => {
                    return `
                    <img src="{{ asset('images/') }}/${image}" alt="" width="200" height="150">
                    `
                }
            },
            {
            ...
            },
            {
                ...
                render: (id) => {
                    return `
                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2 dtlInfo" data-url="/manage/store/menu/data/${id}" data-toggle="modal" title="Edit details"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <a class="btn btn-sm btn-clean btn-icon" href="/manage/store/menu/delete/${id}/{{$store->id}}" title="Delete"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"></rect>
...
<div class="modal fade" id="myModalInsert" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Insert Data Menu</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body" id="modal-body">
                <form class="form" id="form" method="POST" action="{{ route('manage.store.menu.create' , $store->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
