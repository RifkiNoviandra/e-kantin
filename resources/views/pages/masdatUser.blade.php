...
<script>
    ...
    $('.table').DataTable({
        serverSide: true,
        ajax: {
            url: '/api/admin/user/data/dataTable',
        },
        columns: [
            { data: 'id' },
            { data: 'username' },
            ...
            { data: 'balance' },
            { data: 'identity_as',
                render: (identity) => identity.charAt(0).toUpperCase() + identity.slice(1),
            },
            { data: 'status',
                render: (status) => {
                    return status === '1'
            ...
            { data: 'id',
                render: (id) => {
                    return `
                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2 dtlInfo" data-url="/manage/user/${id}" data-toggle="modal" title="Edit details"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <a class="btn btn-sm btn-clean btn-icon" href="/manage/user/delete/${id}" title="Delete"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"></rect>
